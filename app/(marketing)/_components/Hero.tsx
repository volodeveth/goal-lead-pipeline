export default function Hero() {
  return (
    <section className="flex flex-col items-start gap-6 pt-8">
      <span className="rounded-full border border-amber-500/30 bg-amber-500/10 px-3 py-1 text-xs font-medium tracking-wide text-amber-300 uppercase">
        Маркетингова агенція «Ціль»
      </span>
